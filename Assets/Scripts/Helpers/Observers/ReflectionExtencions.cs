...
namespace Helpers.Observers
{
    ...
    {
        public static PropertyOrField GetPublicPropertyOrField(this Type containerType, string name)
        {
            ...
            if( property != null )
            {
                return new PropertyOrField(property);
            }
        ...
        public static T GetPublicFieldOrPropertyValue<T>(this object container, string name)
        {
            ...
            var propertyOrField = containerType.GetPublicPropertyOrField(name);
